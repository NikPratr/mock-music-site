...
import punkOne from '../images/generated-album-art/punk-1.png';
...
export class MusicList {
    ...
    private constructor() {
            const RiotGeneration = new Album('Riot Generation', 'The Damaged and Broken', new Date('2008-05-02'), punkOne, 14.99);
